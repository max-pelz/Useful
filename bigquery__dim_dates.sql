...
date_details as (
    ...
    select
        ...
        -- custom kranus quarter start date calculation
        case
        ...
        (
            ...
            from
                unnest(
                    generate_date_array(
                        '2021-07-01',
                        date_sub(date_add(date_trunc(current_date(), month), interval 2 month), interval 1 day),
                        interval 1 day
                    )
                ) as d
        ) as date_series
...
select
    *,
    ...
    end as last_kranus_quarter_date,
    case
    ...
    end as next_kranus_quarter_date
from date_details
order by id
